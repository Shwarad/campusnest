import { PropertyForRecommendation } from '../types';
...
export function calculatePropertyRecommendation(
  ...
  if (preferences.amenities && preferences.amenities.length > 0) {
    const amenityMap: Record<string, boolean> = property.amenities ?? {
      wifi: !!property.wifi, ac: !!property.ac, attachedBathroom: !!property.attachedBathroom,
      parking: !!property.parking, laundry: !!property.laundry, food: !!property.food,
      powerBackup: !!property.powerBackup, petFriendly: !!property.petFriendly,
    };
...
export function calculateScamRisk(property: PropertyForRecommendation, avgRentInArea: number): {
  score: number;
  ...
  // Inconsistent deposit (deposit > 6x monthly rent is unusual)
