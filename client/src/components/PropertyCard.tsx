      ...
      <div className="p-4">
        ...
        {!compact && (
          <div className="flex gap-2 mb-2.5">
            {property.amenities.wifi && <Wifi className="w-3.5 h-3.5 text-primary-400" aria-label="Wi-Fi" />}
            {property.amenities.ac && <Zap className="w-3.5 h-3.5 text-blue-400" aria-label="AC" />}
            {property.amenities.food && <UtensilsCrossed className="w-3.5 h-3.5 text-amber-400" aria-label="Food" />}
            {property.amenities.parking && <Car className="w-3.5 h-3.5 text-gray-400" aria-label="Parking" />}
          </div>
        )}
